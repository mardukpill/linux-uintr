 ...
 * difference
 */
#define DECLARE_IDTENTRY_XENCB(vector, func) DECLARE_IDTENTRY(vector, func)
 ...
 */
#define DEFINE_IDTENTRY_IST(func) DEFINE_IDTENTRY_RAW(func)
 ...
 * Maps to DEFINE_IDTENTRY_RAW().
 */
#define DEFINE_IDTENTRY_NOIST(func) DEFINE_IDTENTRY_RAW(noist_##func)
 ...
 */
#define DEFINE_IDTENTRY_DF(func) DEFINE_IDTENTRY_RAW_ERRORCODE(func)
 ...
 * Maps to DEFINE_IDTENTRY_RAW_ERRORCODE
 */
#define DEFINE_IDTENTRY_VC_USER(func) DEFINE_IDTENTRY_RAW_ERRORCODE(user_##func)
...
#define DECLARE_IDTENTRY_DF(vector, func) idtentry_df vector asm_##func func

#define DECLARE_IDTENTRY_XENCB(vector, func) DECLARE_IDTENTRY(vector, func)

#define DECLARE_IDTENTRY_VC(vector, func) idtentry_vc vector asm_##func func

#else
#define DECLARE_IDTENTRY_MCE(vector, func) DECLARE_IDTENTRY(vector, func)
...
DECLARE_IDTENTRY_SYSVEC(POSTED_MSI_NOTIFICATION_VECTOR,
...
DECLARE_IDTENTRY_SYSVEC(UINTR_NOTIFICATION_VECTOR,
			sysvec_uintr_spurious_interrupt);

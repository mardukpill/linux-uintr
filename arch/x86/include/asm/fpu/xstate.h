...
#define XFEATURE_MASK_USER_SUPPORTED                                           \
	(XFEATURE_MASK_FP | XFEATURE_MASK_SSE | XFEATURE_MASK_YMM |            \
	 ...
	 XFEATURE_MASK_BNDCSR | XFEATURE_MASK_XTILE)
...
#define XFEATURE_MASK_SUPERVISOR_SUPPORTED \
	(XFEATURE_MASK_PASID | XFEATURE_MASK_CET_USER | \ 
					    XFEATURE_MASK_UINTR)
 ...
 */
#define XFEATURE_MASK_SUPERVISOR_UNSUPPORTED \
	(XFEATURE_MASK_PT | XFEATURE_MASK_CET_KERNEL)

/* All supervisor states including supported and unsupported states. */
#define XFEATURE_MASK_SUPERVISOR_ALL                                      \
	(XFEATURE_MASK_SUPERVISOR_SUPPORTED | XFEATURE_MASK_INDEPENDENT | \
 ...
 */
#define XFEATURE_MASK_SIGFRAME_INITOPT \

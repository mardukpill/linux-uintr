...
#define X86_FEATURE_FXSR_OPT \
	(1 * 32 + 25) /* "fxsr_opt" FXSAVE/FXRSTOR optimizations */
#define X86_FEATURE_GBPAGES (1 * 32 + 26) /* "pdpe1gb" GB pages */
#define X86_FEATURE_RDTSCP (1 * 32 + 27) /* "rdtscp" RDTSCP */
#define X86_FEATURE_LM \
	(1 * 32 + 29) /* "lm" Long Mode (x86-64, 64-bit support) */
...
#define X86_FEATURE_K6_MTRR \
	(3 * 32 + 1) /* "k6_mtrr" AMD K6 nonstandard MTRRs */
#define X86_FEATURE_CYRIX_ARR \
	(3 * 32 + 2) /* "cyrix_arr" Cyrix ARRs (= MTRRs) */
#define X86_FEATURE_CENTAUR_MCR \
	(3 * 32 + 3) /* "centaur_mcr" Centaur MCRs (= MTRRs) */
#define X86_FEATURE_K8 (3 * 32 + 4) /* Opteron, Athlon64 */
#define X86_FEATURE_ZEN5 (3 * 32 + 5) /* CPU based on Zen5 microarchitecture */
#define X86_FEATURE_P3 (3 * 32 + 6) /* P3 */
#define X86_FEATURE_P4 (3 * 32 + 7) /* P4 */
#define X86_FEATURE_CONSTANT_TSC \
	(3 * 32 + 8) /* "constant_tsc" TSC ticks at a constant rate */
#define X86_FEATURE_UP (3 * 32 + 9) /* "up" SMP kernel running on UP */
#define X86_FEATURE_ART (3 * 32 + 10) /* "art" Always running timer (ART) */
#define X86_FEATURE_ARCH_PERFMON \
	(3 * 32 + 11) /* "arch_perfmon" Intel Architectural PerfMon */
...
#define X86_FEATURE_REP_GOOD \
	(3 * 32 + 16) /* "rep_good" REP microcode works well */
#define X86_FEATURE_AMD_LBR_V2 \
	(3 * 32 +              \
	 17) /* "amd_lbr_v2" AMD Last Branch Record Extension Version 2 */
#define X86_FEATURE_CLEAR_CPU_BUF \
	(3 * 32 + 18) /* Clear CPU buffers using VERW */
#define X86_FEATURE_ACC_POWER \
	(3 * 32 + 19) /* "acc_power" AMD Accumulated Power Mechanism */
#define X86_FEATURE_NOPL \
	(3 * 32 + 20) /* "nopl" The NOPL (0F 1F) instructions */
#define X86_FEATURE_ALWAYS (3 * 32 + 21) /* Always-present feature */
#define X86_FEATURE_XTOPOLOGY \
	(3 * 32 + 22) /* "xtopology" CPU topology enum extensions */
#define X86_FEATURE_TSC_RELIABLE \
	(3 * 32 + 23) /* "tsc_reliable" TSC is known to be reliable */
#define X86_FEATURE_NONSTOP_TSC \
	(3 * 32 + 24) /* "nonstop_tsc" TSC does not stop in C states */
#define X86_FEATURE_CPUID \
	(3 * 32 + 25) /* "cpuid" CPU has CPUID instruction itself */
#define X86_FEATURE_EXTD_APICID \
	(3 * 32 + 26) /* "extd_apicid" Extended APICID (8 bits) */
#define X86_FEATURE_AMD_DCM \
	(3 * 32 + 27) /* "amd_dcm" AMD multi-node processor */
#define X86_FEATURE_APERFMPERF \
	(3 * 32 +              \
	 28) /* "aperfmperf" P-State hardware coordination feedback capability (APERF/MPERF MSRs) */
#define X86_FEATURE_RAPL (3 * 32 + 29) /* "rapl" AMD/Hygon RAPL interface */
#define X86_FEATURE_NONSTOP_TSC_S3 \
	(3 * 32 + 30) /* "nonstop_tsc_s3" TSC doesn't stop in S3 state */
#define X86_FEATURE_TSC_KNOWN_FREQ \
	(3 * 32 + 31) /* "tsc_known_freq" TSC has known frequency */

/* Intel-defined CPU features, CPUID level 0x00000001 (ECX), word 4 */
#define X86_FEATURE_XMM3 (4 * 32 + 0) /* "pni" SSE-3 */
#define X86_FEATURE_PCLMULQDQ \
	(4 * 32 + 1) /* "pclmulqdq" PCLMULQDQ instruction */
...
#define X86_FEATURE_TSC_DEADLINE_TIMER \
	(4 * 32 + 24) /* "tsc_deadline_timer" TSC deadline timer */
#define X86_FEATURE_AES (4 * 32 + 25) /* "aes" AES instructions */
#define X86_FEATURE_XSAVE \
	(4 * 32 + 26) /* "xsave" XSAVE/XRSTOR/XSETBV/XGETBV instructions */
...
#define X86_FEATURE_HYPERVISOR \
	(4 * 32 + 31) /* "hypervisor" Running on a hypervisor */
...
#define X86_FEATURE_ACE2 \
	(5 * 32 + 8) /* "ace2" Advanced Cryptography Engine v2 */
...
#define X86_FEATURE_CMP_LEGACY \
	(6 * 32 + 1) /* "cmp_legacy" If yes HyperThreading not valid */
...
#define X86_FEATURE_CR8_LEGACY \
	(6 * 32 + 4) /* "cr8_legacy" CR8 in 32-bit mode */
...
#define X86_FEATURE_MISALIGNSSE \
	(6 * 32 + 7) /* "misalignsse" Misaligned SSE mode */
#define X86_FEATURE_3DNOWPREFETCH \
	(6 * 32 + 8) /* "3dnowprefetch" 3DNow prefetch instructions */
...
#define X86_FEATURE_TOPOEXT \
	(6 * 32 + 22) /* "topoext" Topology extensions CPUID leafs */
#define X86_FEATURE_PERFCTR_CORE \
	(6 * 32 + 23) /* "perfctr_core" Core performance counter extensions */
#define X86_FEATURE_PERFCTR_NB \
	(6 * 32 + 24) /* "perfctr_nb" NB performance counter extensions */
#define X86_FEATURE_BPEXT (6 * 32 + 26) /* "bpext" Data breakpoint extension */
#define X86_FEATURE_PTSC \
	(6 * 32 + 27) /* "ptsc" Performance time-stamp counter */
...
#define X86_FEATURE_RING3MWAIT \
	(7 * 32 + 0) /* "ring3mwait" Ring 3 MONITOR/MWAIT instructions */
#define X86_FEATURE_CPUID_FAULT \
	(7 * 32 + 1) /* "cpuid_fault" Intel CPUID faulting */
...
#define X86_FEATURE_IBRS \
	(7 * 32 + 25) /* "ibrs" Indirect Branch Restricted Speculation */
#define X86_FEATURE_IBPB \
	(7 * 32 + 26) /* "ibpb" Indirect Branch Prediction Barrier */
#define X86_FEATURE_STIBP \
	(7 * 32 + 27) /* "stibp" Single Thread Indirect Branch Predictors */
#define X86_FEATURE_ZEN (7 * 32 + 28) /* Generic flag for all Zen and newer */
#define X86_FEATURE_L1TF_PTEINV \
	(7 * 32 + 29) /* L1TF workaround PTE inversion */
#define X86_FEATURE_IBRS_ENHANCED \
	(7 * 32 + 30) /* "ibrs_enhanced" Enhanced IBRS */
...
#define X86_FEATURE_FLEXPRIORITY \
	(8 * 32 + 1) /* "flexpriority" Intel FlexPriority */
#define X86_FEATURE_EPT (8 * 32 + 2) /* "ept" Intel Extended Page Table */
#define X86_FEATURE_VPID (8 * 32 + 3) /* "vpid" Intel Virtual Processor ID */

#define X86_FEATURE_VMMCALL \
	(8 * 32 + 15) /* "vmmcall" Prefer VMMCALL to VMCALL */
#define X86_FEATURE_XENPV (8 * 32 + 16) /* Xen paravirtual guest */
#define X86_FEATURE_EPT_AD \
	(8 * 32 + 17) /* "ept_ad" Intel Extended Page Table access-dirty bit */
...
#define X86_FEATURE_TDX_GUEST \
	(8 * 32 + 22) /* "tdx_guest" Intel Trust Domain Extensions Guest */
...
#define X86_FEATURE_TSC_ADJUST \
	(9 * 32 + 1) /* "tsc_adjust" TSC adjustment MSR 0x3B */
#define X86_FEATURE_SGX (9 * 32 + 2) /* "sgx" Software Guard Extensions */
#define X86_FEATURE_BMI1 \
	(9 * 32 + 3) /* "bmi1" 1st group bit manipulation extensions */
...
#define X86_FEATURE_SMEP \
	(9 * 32 + 7) /* "smep" Supervisor Mode Execution Protection */
#define X86_FEATURE_BMI2 \
	(9 * 32 + 8) /* "bmi2" 2nd group bit manipulation extensions */
#define X86_FEATURE_ERMS \
	(9 * 32 + 9) /* "erms" Enhanced REP MOVSB/STOSB instructions */
#define X86_FEATURE_INVPCID \
	(9 * 32 + 10) /* "invpcid" Invalidate Processor Context ID */
#define X86_FEATURE_RTM \
	(9 * 32 + 11) /* "rtm" Restricted Transactional Memory */
...
#define X86_FEATURE_RDT_A \
	(9 * 32 + 15) /* "rdt_a" Resource Director Technology Allocation */
...
#define X86_FEATURE_XGETBV1 \
	(10 * 32 + 2) /* "xgetbv1" XGETBV with ECX = 1 instruction */
#define X86_FEATURE_XSAVES \
	(10 * 32 + 3) /* "xsaves" XSAVES/XRSTORS instructions */
...
#define X86_FEATURE_CQM_OCCUP_LLC \
	(11 * 32 + 1) /* "cqm_occup_llc" LLC occupancy monitoring */
#define X86_FEATURE_CQM_MBM_TOTAL \
	(11 * 32 + 2) /* "cqm_mbm_total" LLC Total MBM monitoring */
#define X86_FEATURE_CQM_MBM_LOCAL \
	(11 * 32 + 3) /* "cqm_mbm_local" LLC Local MBM monitoring */
...
#define X86_FEATURE_SPLIT_LOCK_DETECT \
	(11 * 32 + 6) /* "split_lock_detect" #AC for split lock */
...
#define X86_FEATURE_ENTRY_IBPB \
	(11 * 32 + 10) /* Issue an IBPB on kernel entry */
...
#define X86_FEATURE_RETPOLINE_LFENCE \
	(11 * 32 + 13) /* Use LFENCE for Spectre variant 2 */
#define X86_FEATURE_RETHUNK (11 * 32 + 14) /* Use REturn THUNK */
#define X86_FEATURE_UNRET (11 * 32 + 15) /* AMD BTB untrain return */
#define X86_FEATURE_USE_IBPB_FW \
	(11 * 32 + 16) /* Use IBPB during runtime firmware calls */
#define X86_FEATURE_RSB_VMEXIT_LITE \
	(11 * 32 + 17) /* Fill RSB on VM exit when EIBRS is enabled */
#define X86_FEATURE_SGX_EDECCSSA \
	(11 * 32 + 18) /* SGX EDECCSSA user leaf function */
#define X86_FEATURE_CALL_DEPTH \
	(11 * 32 + 19) /* Call depth tracking for RSB stuffing */
#define X86_FEATURE_MSR_TSX_CTRL \
	(11 * 32 + 20) /* MSR IA32_TSX_CTRL (Intel) implemented */
#define X86_FEATURE_SMBA (11 * 32 + 21) /* Slow Memory Bandwidth Allocation */
#define X86_FEATURE_BMEC \
	(11 * 32 + 22) /* Bandwidth Monitoring Event Configuration */
#define X86_FEATURE_USER_SHSTK \
	(11 * 32 +             \
	 23) /* "user_shstk" Shadow stack support for user mode applications */
#define X86_FEATURE_SRSO (11 * 32 + 24) /* AMD BTB untrain RETs */
#define X86_FEATURE_SRSO_ALIAS \
	(11 * 32 + 25) /* AMD BTB untrain RETs through aliasing */
#define X86_FEATURE_IBPB_ON_VMEXIT \
	(11 * 32 + 26) /* Issue an IBPB only on VMEXIT */
#define X86_FEATURE_APIC_MSRS_FENCE \
	(11 * 32 + 27) /* IA32_TSC_DEADLINE and X2APIC MSRs need fencing */
#define X86_FEATURE_ZEN2 \
	(11 * 32 + 28) /* CPU based on Zen2 microarchitecture */
#define X86_FEATURE_ZEN3 \
	(11 * 32 + 29) /* CPU based on Zen3 microarchitecture */
#define X86_FEATURE_ZEN4 \
	(11 * 32 + 30) /* CPU based on Zen4 microarchitecture */
#define X86_FEATURE_ZEN1 \
	(11 * 32 + 31) /* CPU based on Zen1 microarchitecture */

/* Intel-defined CPU features, CPUID level 0x00000007:1 (EAX), word 12 */
#define X86_FEATURE_AVX_VNNI \
	(12 * 32 + 4) /* "avx_vnni" AVX VNNI instructions */
#define X86_FEATURE_AVX512_BF16 \
	(12 * 32 + 5) /* "avx512_bf16" AVX512 BFLOAT16 instructions */
#define X86_FEATURE_CMPCCXADD (12 * 32 + 7) /* CMPccXADD instructions */
#define X86_FEATURE_ARCH_PERFMON_EXT \
	(12 * 32 + 8) /* Intel Architectural PerfMon Extension */
#define X86_FEATURE_FZRM (12 * 32 + 10) /* Fast zero-length REP MOVSB */
#define X86_FEATURE_FSRS (12 * 32 + 11) /* Fast short REP STOSB */
#define X86_FEATURE_FSRC (12 * 32 + 12) /* Fast short REP {CMPSB,SCASB} */
#define X86_FEATURE_FRED \
	(12 * 32 + 17) /* "fred" Flexible Return and Event Delivery */
...
#define X86_FEATURE_IRPERF \
	(13 * 32 + 1) /* "irperf" Instructions Retired Count */
#define X86_FEATURE_XSAVEERPTR \
	(13 * 32 + 2) /* "xsaveerptr" Always save/restore FP error pointers */
#define X86_FEATURE_RDPRU \
	(13 * 32 + 4) /* "rdpru" Read processor register at user level */
...
#define X86_FEATURE_HWP_ACT_WINDOW \
	(14 * 32 + 9) /* "hwp_act_window" HWP Activity Window */
#define X86_FEATURE_HWP_EPP \
	(14 * 32 + 10) /* "hwp_epp" HWP Energy Perf. Preference */
#define X86_FEATURE_HWP_PKG_REQ \
	(14 * 32 + 11) /* "hwp_pkg_req" HWP Package Level Request */
...
#define X86_FEATURE_FLUSHBYASID \
	(15 * 32 + 6) /* "flushbyasid" Flush-by-ASID support */
#define X86_FEATURE_DECODEASSISTS \
	(15 * 32 + 7) /* "decodeassists" Decode Assists support */
#define X86_FEATURE_PAUSEFILTER \
	(15 * 32 + 10) /* "pausefilter" Filtered pause intercept */
#define X86_FEATURE_PFTHRESHOLD \
	(15 * 32 + 12) /* "pfthreshold" Pause filter threshold */
#define X86_FEATURE_AVIC \
	(15 * 32 + 13) /* "avic" Virtual Interrupt Controller */
#define X86_FEATURE_V_VMSAVE_VMLOAD \
	(15 * 32 + 15) /* "v_vmsave_vmload" Virtual VMSAVE VMLOAD */
#define X86_FEATURE_VGIF (15 * 32 + 16) /* "vgif" Virtual GIF */
#define X86_FEATURE_X2AVIC (15 * 32 + 18) /* "x2avic" Virtual x2apic */
#define X86_FEATURE_V_SPEC_CTRL \
	(15 * 32 + 20) /* "v_spec_ctrl" Virtual SPEC_CTRL */
...
#define X86_FEATURE_UMIP \
	(16 * 32 + 2) /* "umip" User Mode Instruction Protection */
...
#define X86_FEATURE_WAITPKG \
	(16 * 32 + 5) /* "waitpkg" UMONITOR/UMWAIT/TPAUSE Instructions */
...
#define X86_FEATURE_GFNI \
	(16 * 32 + 8) /* "gfni" Galois Field New Instructions */
...
#define X86_FEATURE_AVX512_VNNI \
	(16 * 32 + 11) /* "avx512_vnni" Vector Neural Network Instructions */
...
#define X86_FEATURE_AVX512_VPOPCNTDQ \
	(16 * 32 + 14) /* "avx512_vpopcntdq" POPCNT for vectors of DW/QW */
#define X86_FEATURE_LA57 (16 * 32 + 16) /* "la57" 5-level page tables */
#define X86_FEATURE_RDPID (16 * 32 + 22) /* "rdpid" RDPID instruction */
#define X86_FEATURE_BUS_LOCK_DETECT \
	(16 * 32 + 24) /* "bus_lock_detect" Bus Lock detect */
#define X86_FEATURE_CLDEMOTE \
	(16 * 32 + 25) /* "cldemote" CLDEMOTE instruction */
#define X86_FEATURE_MOVDIRI (16 * 32 + 27) /* "movdiri" MOVDIRI instruction */
#define X86_FEATURE_MOVDIR64B \
	(16 * 32 + 28) /* "movdir64b" MOVDIR64B instruction */
#define X86_FEATURE_ENQCMD \
	(16 * 32 + 29) /* "enqcmd" ENQCMD and ENQCMDS instructions */
#define X86_FEATURE_SGX_LC \
	(16 * 32 + 30) /* "sgx_lc" Software Guard Extensions Launch Control */

/* AMD-defined CPU features, CPUID level 0x80000007 (EBX), word 17 */
#define X86_FEATURE_OVERFLOW_RECOV \
	(17 * 32 + 0) /* "overflow_recov" MCA overflow recovery support */
#define X86_FEATURE_SUCCOR \
	(17 * 32 +         \
	 1) /* "succor" Uncorrectable error containment and recovery */
...
#define X86_FEATURE_SEV \
	(19 * 32 + 1) /* "sev" AMD Secure Encrypted Virtualization */
#define X86_FEATURE_VM_PAGE_FLUSH \
	(19 * 32 + 2) /* VM Page Flush MSR is supported */
#define X86_FEATURE_SEV_ES \
	(19 * 32 +         \
	 3) /* "sev_es" AMD Secure Encrypted Virtualization - Encrypted State */
#define X86_FEATURE_SEV_SNP \
	(19 * 32 +          \
	 4) /* "sev_snp" AMD Secure Encrypted Virtualization - Secure Nested Paging */
#define X86_FEATURE_V_TSC_AUX (19 * 32 + 9) /* Virtual TSC_AUX */
#define X86_FEATURE_SME_COHERENT \
	(19 * 32 + 10) /* AMD hardware-enforced cache coherency */
#define X86_FEATURE_DEBUG_SWAP \
	(19 * 32 +             \
	 14) /* "debug_swap" AMD SEV-ES full debug state swap support */
#define X86_FEATURE_SVSM (19 * 32 + 28) /* "svsm" SVSM present */

/* AMD-defined Extended Feature 2 EAX, CPUID level 0x80000021 (EAX), word 20 */
#define X86_FEATURE_NO_NESTED_DATA_BP \
	(20 * 32 + 0) /* No Nested Data Breakpoints */
#define X86_FEATURE_WRMSR_XX_BASE_NS \
	(20 * 32 + 1) /* WRMSR to {FS,GS,KERNEL_GS}_BASE is non-serializing */
#define X86_FEATURE_LFENCE_RDTSC \
	(20 * 32 + 2) /* LFENCE always serializing / synchronizes RDTSC */
#define X86_FEATURE_NULL_SEL_CLR_BASE \
	(20 * 32 + 6) /* Null Selector Clears Base */
#define X86_FEATURE_AUTOIBRS (20 * 32 + 8) /* Automatic IBRS */
#define X86_FEATURE_NO_SMM_CTL_MSR \
	(20 * 32 + 9) /* SMM_CTL MSR is not present */

#define X86_FEATURE_SBPB \
	(20 * 32 + 27) /* Selective Branch Prediction Barrier */
#define X86_FEATURE_IBPB_BRTYPE \
	(20 * 32 +              \
	 28) /* MSR_PRED_CMD[IBPB] flushes all branch type predictions */
...
#define X86_FEATURE_AMD_LBR_PMC_FREEZE \
	(21 * 32 + 0) /* "amd_lbr_pmc_freeze" AMD LBR and PMC Freeze */
#define X86_FEATURE_CLEAR_BHB_LOOP \
	(21 * 32 + 1) /* Clear branch history at syscall entry using SW loop */
#define X86_FEATURE_BHI_CTRL (21 * 32 + 2) /* BHI_DIS_S HW control available */
#define X86_FEATURE_CLEAR_BHB_HW \
	(21 * 32 + 3) /* BHI_DIS_S HW control enabled */
#define X86_FEATURE_CLEAR_BHB_LOOP_ON_VMEXIT \
	(21 * 32 + 4) /* Clear branch history at vmexit using SW loop */
...
#define X86_BUG_FXSAVE_LEAK \
	X86_BUG(6) /* "fxsave_leak" FXSAVE leaks FOP/FIP/FOP */
#define X86_BUG_CLFLUSH_MONITOR \
	X86_BUG(7) /* "clflush_monitor" AAI65, CLFLUSH required before MONITOR */
#define X86_BUG_SYSRET_SS_ATTRS \
	X86_BUG(8) /* "sysret_ss_attrs" SYSRET doesn't fix up SS attrs */
#ifdef CONFIG_X86_32
/*
...
#define X86_BUG_NULL_SEG \
	X86_BUG(10) /* "null_seg" Nulling a selector preserves the base */
#define X86_BUG_SWAPGS_FENCE \
	X86_BUG(11) /* "swapgs_fence" SWAPGS without input dep on GS */
#define X86_BUG_MONITOR \
	X86_BUG(12) /* "monitor" IPI required to wake up remote CPU */
#define X86_BUG_AMD_E400 \
	X86_BUG(13) /* "amd_e400" CPU is among the affected by Erratum 400 */
#define X86_BUG_CPU_MELTDOWN \
	X86_BUG(14) /* "cpu_meltdown" CPU is affected by meltdown attack and needs kernel page table isolation */
#define X86_BUG_SPECTRE_V1 \
	X86_BUG(15) /* "spectre_v1" CPU is affected by Spectre variant 1 attack with conditional branches */
#define X86_BUG_SPECTRE_V2 \
	X86_BUG(16) /* "spectre_v2" CPU is affected by Spectre variant 2 attack with indirect branches */
#define X86_BUG_SPEC_STORE_BYPASS \
	X86_BUG(17) /* "spec_store_bypass" CPU is affected by speculative store bypass attack */
#define X86_BUG_L1TF \
	X86_BUG(18) /* "l1tf" CPU is affected by L1 Terminal Fault */
#define X86_BUG_MDS \
	X86_BUG(19) /* "mds" CPU is affected by Microarchitectural data sampling */
#define X86_BUG_MSBDS_ONLY \
	X86_BUG(20) /* "msbds_only" CPU is only affected by the  MSDBS variant of BUG_MDS */
#define X86_BUG_SWAPGS \
	X86_BUG(21) /* "swapgs" CPU is affected by speculation through SWAPGS */
#define X86_BUG_TAA \
	X86_BUG(22) /* "taa" CPU is affected by TSX Async Abort(TAA) */
#define X86_BUG_ITLB_MULTIHIT \
	X86_BUG(23) /* "itlb_multihit" CPU may incur MCE during certain page attribute changes */
#define X86_BUG_SRBDS \
	X86_BUG(24) /* "srbds" CPU may leak RNG bits if not mitigated */
#define X86_BUG_MMIO_STALE_DATA \
	X86_BUG(25) /* "mmio_stale_data" CPU is affected by Processor MMIO Stale Data vulnerabilities */
#define X86_BUG_MMIO_UNKNOWN \
	X86_BUG(26) /* "mmio_unknown" CPU is too old and its MMIO Stale Data status is unknown */
#define X86_BUG_RETBLEED \
	X86_BUG(27) /* "retbleed" CPU is affected by RETBleed */
#define X86_BUG_EIBRS_PBRSB \
	X86_BUG(28) /* "eibrs_pbrsb" EIBRS is vulnerable to Post Barrier RSB Predictions */
#define X86_BUG_SMT_RSB \
	X86_BUG(29) /* "smt_rsb" CPU is vulnerable to Cross-Thread Return Address Predictions */
#define X86_BUG_GDS \
	X86_BUG(30) /* "gds" CPU is affected by Gather Data Sampling */
#define X86_BUG_TDX_PW_MCE \
	X86_BUG(31) /* "tdx_pw_mce" CPU may incur #MC if non-TD software does partial write to TDX private memory */
...
#define X86_BUG_RFDS     \
	X86_BUG(1 * 32 + \
		2) /* "rfds" CPU is vulnerable to Register File Data Sampling */
#define X86_BUG_BHI      \
	X86_BUG(1 * 32 + \
		3) /* "bhi" CPU is affected by Branch History Injection */
